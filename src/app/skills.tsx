    ...
    <>
      ...
      <div className="flex ml-4 rtl:mr-4 justify-start  flex-wrap">
        {SkillItems.BackEnd.map((be) => (
          <div
            className="bg-gray-200 dark:bg-gray-950 m-2 font-light rounded-lg p-2 text-amber-900 dark:text-amber-300"
            key={be}
          >
            {be}
          </div>
      ...
      <div className="flex ml-4 rtl:mr-4 justify-start  flex-wrap">
        {SkillItems.FrontEnd.map((fe) => (
          <div
            className="bg-gray-200 dark:bg-gray-950 m-2  font-light rounded-lg p-2 dark:text-amber-300 text-amber-900"
            key={fe}
          >
            {fe}
          </div>
